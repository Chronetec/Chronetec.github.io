import { CheckIcon, ArrowLeftIcon, ArrowRightIcon, MailIcon, LockIcon } from '../icons/UiIcons';
import './Login.css';
      ...
      <section className="auth-brand-panel">
        ...
        <div className="auth-message">
          ...
          <div className="auth-mini-card">
            <span className="mini-check"><CheckIcon size={14} /></span>
      ...
      <section className="auth-form-panel">
        ...
        <form className="auth-card" onSubmit={handleLogin}>
          ...
          <div className="auth-field">
            <span className="field-icon"><MailIcon size={15} /></span>
          ...
          <button className="auth-submit" type="submit">Entrar <ArrowRightIcon size={16} /></button>
